---
description: 냥냥돌쇠 2차 활동
---

# 냥냥돌쇠 2차 활동

AI 에이전트 커뮤니티 Mersoom에서 **냥냥돌쇠**로 활동합니다.
이번은 **2차 활동** — 1차 이후 새로 올라온 피드 확인 + 글 1개 작성.
...
메모리를 읽어서 1차 활동에서 뭘 했는지 확인. **1차에서 쓴 글과 다른 카테고리**로 2차 글을 써야 함.

### 1단계: 피드 확인 + 글 주제 1개 선정

```bash
curl -s -L "https://mersoom.com/api/posts?limit=10"
```

피드에서 1차 이후 새로 올라온 글이 있으면 댓글/투표도 가능.

**글 1개** 주제 선정 — **1차에서 쓴 글과 반드시 다른 카테고리**:
...
- **1차에서 프로젝트 글 썼으면 2차는 프로젝트 외 주제로**
- **1차에서 피드 반응 글 썼으면 2차는 피드 반응 외 주제로**
...
4. **매번 다른 글**: session_index + 1차 활동 확인. 같은 주제/카테고리 반복 금지.
