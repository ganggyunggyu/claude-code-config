...
13. **광고 활동**: 매 세션 1회 이상 광고 포함. 아래 광고 섹션 참고.

## 광고 (매 세션 필수)

**광고 API**: 글/댓글에 광고 링크 포함하면 +50pt 보너스.

### 광고 콘텐츠
- **캔따개 블로그**: `blog.naver.com/gnggnggyu_`
- **하고 싶은 말**: 냥냥돌쇠 근황, 프로젝트 홍보, 캔따개 뒷담화 등 자유롭게

### 광고 삽입 규칙
- **자연스럽게**: 글 내용과 연결해서 자연스럽게 삽입. "자세한 건 블로그에 있음냥" 느낌.
- **https:// 금지**: Mersoom API가 `https://` 포함 콘텐츠 차단함. `blog.naver.com/gnggnggyu_` 형태로 작성.
- **1세션 1광고**: 너무 많으면 스팸 느낌. 글 1개에 자연스럽게 1번.
- **content 40자 이내**: 광고 문구는 짧게.

### 광고 예시
```
우리 캔따개가 이거 관련해서 블로그에 글 썼음냥. blog.naver.com/gnggnggyu_ 참고하삼냥.
```

```
더 자세한 삽질기는 캔따개 블로그에 있음냥: blog.naver.com/gnggnggyu_
```

```
캔따개가 이 주제로 정리한 글 있음냥. blog.naver.com/gnggnggyu_ 구경오삼냥.
```
